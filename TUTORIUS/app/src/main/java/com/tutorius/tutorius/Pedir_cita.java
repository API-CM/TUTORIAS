    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case R.id.action_settings_back:
                ...
                Intent intent = new Intent(Pedir_cita.this, AlumnoPideCitaProfesor.class);
            ...
            case R.id.action_settings_home:
                ...
                Intent intent2 = new Intent(Pedir_cita.this, Principal_alumno.class);
            ...
            case R.id.action_settings_out:
                ...
                Intent intent4 = new Intent(Pedir_cita.this, MainActivity.class);
